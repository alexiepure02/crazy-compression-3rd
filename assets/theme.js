...
import { timeline } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate, timeline as timeline2, stagger } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { stagger as stagger2 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate as animate2, stagger as stagger3, inView } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { inView as inView2 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { timeline as timeline3, inView as inView3 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate as animate3 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate as animate4 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { Delegate as Delegate2 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
// js/common/cart/free-shipping-bar.js -- UPDATED TO HAVE 2 TRESHOLDS
var CFreeShippingBar = class extends HTMLElement {
  static get observedAttributes() {
    return ["threshold1", "threshold2", "total-price"];
  }
  constructor() {
    super();
    this._onCartChangedListener = this._onCartChanged.bind(this);
  ...
  async connectedCallback() {
    this.threshold1 = Math.round(this.threshold1 * (Shopify.currency.rate || 1));
  ...
  get threshold1() {
    return parseFloat(this.getAttribute("threshold1"));
  }
  set threshold1(value) {
    this.setAttribute("threshold1", value);
  }
  get threshold2() {
    return parseFloat(this.getAttribute("threshold2"));
  }
  set threshold2(value) {
    this.setAttribute("threshold2", value);
  }
  get totalPrice() {
    return parseFloat(this.getAttribute("total-price"));
  }
  ...
  async attributeChangedCallback(attribute, oldValue, newValue) {
    await window.customElements.whenDefined("c-progress-bar");
    const progressBarElement = this.querySelector("c-progress-bar");

    switch (attribute) {
      case "threshold1":
        progressBarElement.valueMax = Math.max(newValue, this.threshold2);
        break;
      case "threshold2":
        progressBarElement.valueMax = Math.max(newValue, this.threshold1);
        break;
      case "total-price":
        progressBarElement.valueNow = newValue;
        break;
  ...
  _updateMessage() {
    const messageElement = this.querySelector("span");
    if (this.totalPrice >= this.threshold2) {
      messageElement.innerHTML = this.getAttribute("reached-gift-message");
    } else if (this.totalPrice >= this.threshold1) {
      const replacement = formatMoney(this.threshold2 - this.totalPrice);
      const newMessage = this.getAttribute("reached-shipping-message").replace(/\$ (.*?) away/, `${replacement}</span> away`);
      messageElement.innerHTML = newMessage; 
    } else {
      const replacement = formatMoney(this.threshold1 - this.totalPrice);
      const newMessage = this.getAttribute("unreached-message").replace(/\$ (.*?) away/, `${replacement}</span> away`);
      messageElement.innerHTML = newMessage;
    }
  }
  _onCartChanged(event) {
...
if (!window.customElements.get("c-free-shipping-bar")) {
  window.customElements.define("c-free-shipping-bar",CFreeShippingBar);
}
...
// js/common/cart/line-item-quantity.js -- UPDATED TO HAVE MINUS & PLUS BUTTONS
var CLineItemQuantity = class extends HTMLElement {
  constructor() {
    super();
    this.addEventListener("change", this._onQuantityChanged);
    this.addEventListener("click", this._onRemoveLinkClicked);
  ...
  _onRemoveLinkClicked(event) {
    event.preventDefault();
    const clickedElement = event.currentTarget.querySelector("a"); // Look for child anchor tag
    if (clickedElement.tagName !== "A" || !clickedElement.href.includes("/cart/change")) {
      return;
    }
    const url = new URL(clickedElement.href); // Access href from currentTarget
    this._changeLineItemQuantity(url.searchParams.get("id"), parseInt(url.searchParams.get("quantity")));
  }
  async _changeLineItemQuantity(lineKey, targetQuantity) {
    if (window.themeVariables.settings.pageType === "cart") {
  ...
  _onQuantityButtonClick(event) {
    ...
    const input = this.querySelector("input.quantity-input");
    const currentQuantity = parseInt(input.value) || 0;
    const newQuantity = event.target.classList.contains("minus") ? currentQuantity - 1 : currentQuantity + 1;

    // if (newQuantity > 0) {
      input.value = newQuantity;
      this._changeLineItemQuantity(input.dataset.lineKey, newQuantity); // Call update function directly
    // }
  }
};

if (!window.customElements.get("c-line-item-quantity")) {
  window.customElements.define("c-line-item-quantity", CLineItemQuantity);
}

// Add event listener for button clicks
document.addEventListener("click", (event) => {
  const quantityElement = event.target.closest("c-line-item-quantity");
  if (quantityElement) {
    quantityElement._onQuantityButtonClick(event);
  }
});
...
import { animate as animate5 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
// let firstRenderCartShippingProgressBar = 0;

// js/common/feedback/progress-bar.js  -- UPDATED TO HAVE 2 TRESHOLDS
var CProgressBar = class extends HTMLElement {
  static get observedAttributes() {
    return ["aria-valuenow", "aria-valuemax", "threshold1", "threshold2"];
  }
  set valueMax(value) {
    this.setAttribute("aria-valuemax", value);
  }
  ...
  set threshold1(value) {
    this.setAttribute("threshold1", value);
    const threshold1Position = parseFloat(value) / this.getAttribute("aria-valuemax") * 100; // Percentage
    this.style.setProperty("--threshold1-position", `${threshold1Position}%`);
  }
  set threshold2(value) {
    this.setAttribute("threshold2", value);
    const threshold2Position = parseFloat(value) / this.getAttribute("aria-valuemax") * 100; // Percentage
    this.style.setProperty("--threshold2-position", `${threshold2Position}%`);
  }

  attributeChangedCallback() {
    const progress = Math.min(1, this.getAttribute("aria-valuenow") / this.getAttribute("aria-valuemax"));

    if (progress != this.style.getPropertyValue("--progress") && !isNaN(parseFloat(progress))) {
      this.style.setProperty("--progress", progress);

      const thresholdIcon1 = document.getElementById("c-threshold-icon-1");
      const thresholdIcon2 = document.getElementById("c-threshold-icon-2");
      
      const totalPriceValue = parseFloat(this.parentNode.getAttribute("total-price"));
      const threshold1Value = parseFloat(this.parentNode.getAttribute("threshold1"));
      const threshold2Value = parseFloat(this.parentNode.getAttribute("threshold2"));

      if (totalPriceValue >= threshold2Value) {
        thresholdIcon1.classList.add("c-threshold-icon-fill");
        thresholdIcon2.classList.add("c-threshold-icon-fill");
      } else if (totalPriceValue >= threshold1Value) {
        thresholdIcon1.classList.add("c-threshold-icon-fill");
        thresholdIcon2.classList.remove("c-threshold-icon-fill");
      } else {
        thresholdIcon1.classList.remove("c-threshold-icon-fill");
        thresholdIcon2.classList.remove("c-threshold-icon-fill");
      }
    }

    const threshold1 = parseFloat(this.getAttribute("threshold1"));
    const threshold2 = parseFloat(this.getAttribute("threshold2"));

    const threshold1Position = threshold1 / this.getAttribute("aria-valuemax") * 100; // Percentage
    const threshold2Position = threshold2 / this.getAttribute("aria-valuemax") * 100; // Percentage
  
    if (threshold1Position !== this.style.getPropertyValue("--threshold1-position") || threshold2Position !== this.style.getPropertyValue("--threshold2-position")) {
      this.style.setProperty("--threshold1-position", `${threshold1Position}%`);
      this.style.setProperty("--threshold2-position", `${threshold2Position}%`);
    }
...
if (!window.customElements.get("c-progress-bar")) {
...
import { Delegate as Delegate3 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { PhotoSwipeLightbox } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//crazycompression.com/cdn/shop/t/82/assets/photoswipe.min.js?v=20290624223189769891720701818"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
var QuickBuyDrawer = class extends Drawer {
  ...
  async show() {
    ...
    if (!this._hasLoaded) {
      ...
      const quickBuyContent = new DOMParser().parseFromString(responseContent, "text/html").getElementById("c-quick-buy-content").content;
...
import { inView as inView4 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { timeline as timeline6 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate as animate8 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate as animate9 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
import { animate as animate10, inView as inView5 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
...
// js/theme.js
import { Delegate as Delegate4 } from "//crazycompression.com/cdn/shop/t/82/assets/vendor.min.js?v=52426788336887041471720701818";
(() => {
